<template>
  <div class="payment-page">
    <form class="payment__form" @submit.prevent="verifyForm" v-if="this.userData.number">
      <InputSum :currency="currency.euro" @inputSumChange="changeSum" :form="form.errorClass" :userData="userData"></InputSum>
      <PaymentCard :currency="currency.euro" :sum="sum" :form="form.errorClass" :userData="userData" ></PaymentCard>
  ...
  methods: {
    ...
    verifyForm(e) {
      ...
      if (
        ...
        parseFloat(this.form.card__exp_year) > 30 ||
    ...
    getUserData() {
      const url = 'http://www.mocky.io/v2/5eaffb6c3300005c00c68a8a'
      fetch(url)
